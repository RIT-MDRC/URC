 ...
 *      1. CONSTRUCTOR
 *      2. COMMON ERROR FUNCTIONS
 *      2. COMMON MOTION FUNCTIONS
 *      3. MOTOR SPECIFIC FUNCTIONS
 *      4. LINEAR SPECIFIC FUNCTIONS
 *      5. MISC COMMON FUNCTIONS
 *      6. GETTERS AND SETTERS
 *      7. I2C COMMUNICATION FUNCTIONS
 */
